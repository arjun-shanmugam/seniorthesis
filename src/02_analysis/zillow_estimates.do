...
/******************************************************************************/
import delimited "/Users/arjunshanmugam/Documents/GitHub/seniorthesis/data/03_cleaned/zillow_panel_restricted.csv", clear bindquote(strict)
...
drop if city_year_count < 2
drop city_year_count
count
ivregress 2sls v112 (judgment_for_plaintiff=i.court_person_encoded) i.city_year, robust

// Run OLS regression estimates. 
eststo clear
local outcomes v123 v122 v121
