...
\begin{tabular}{l*{4}{c}}
\toprule
                    &\multicolumn{1}{c}{\shortstack{\textbf{Full}\\Sample}}&\multicolumn{1}{c}{\shortstack{\textbf{Cases Won}\\By Plaintiff}}&\multicolumn{1}{c}{\shortstack{\textbf{Cases Won}\\By Defendant}}&\multicolumn{1}{c}{\shortstack{\textbf{Difference}\\Mean, P-Value}}\\
\midrule
